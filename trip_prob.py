...
for participant_path in participants:
    ...
    # Go through each colour and dot pair and find all the probability for each and join the tables together into one
    #  table.
    ...
    # Save output to CSV
    output_df.to_csv("%s/participant_%s_probability.csv" % (constants.PARTICIPANT_PROBABILITY_PATH, participant_num))
